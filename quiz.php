...
<script>
  ...
  function updateTimer() {
    ...
    timerEl.textContent = `Time Remaining: ${minutes < 10 ? '0' : ''}${minutes}:${seconds < 10 ? '0' : ''}${seconds}`;

    // Blink every full minute (except at start)
    if (seconds === 0 && duration !== 5*60) {
      timerEl.classList.add("blink");
      setTimeout(() => timerEl.classList.remove("blink"), 1000);
    }
