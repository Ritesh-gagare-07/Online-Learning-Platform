...
<section class="bg-gradient-to-r from-[#1b2a49] to-[#004d40] text-white py-20">
  <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 items-center gap-10">
    ...
    <div class="flex justify-center" data-aos="fade-left">
      <img src="https://img.freepik.com/free-vector/online-learning-illustration_33099-5262.jpg" class="rounded-xl shadow-lg max-h-96" alt="Learning">
    </div>
  </div>
</section>
...
<section class="py-16">
  <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div data-aos="fade-left" class="order-1 md:order-2">
      <img src="https://img.freepik.com/free-vector/online-education-concept_23-2148533382.jpg" class="rounded-xl shadow-lg" alt="Career Growth">
    </div>
  </div>
</section>

<!-- EXTRA FEATURES -->
<section class="bg-[#004d40] text-white py-16">
  <div class="max-w-6xl mx-auto px-6 text-center">
    ...
    <div class="grid md:grid-cols-4 gap-6">
      <div class="p-5 bg-[#1b2a49] rounded-xl shadow hover:shadow-lg transition" data-aos="flip-left">
        ...
        <p class="text-sm text-gray-200">Learn from industry experts.</p>
      </div>
      <div class="p-5 bg-[#1b2a49] rounded-xl shadow hover:shadow-lg transition" data-aos="flip-left" data-aos-delay="100">
        ...
        <p class="text-sm text-gray-200">Test yourself with tasks.</p>
      </div>
      <div class="p-5 bg-[#1b2a49] rounded-xl shadow hover:shadow-lg transition" data-aos="flip-left" data-aos-delay="200">
        ...
        <p class="text-sm text-gray-200">Verifiable credentials.</p>
      </div>
      <div class="p-5 bg-[#1b2a49] rounded-xl shadow hover:shadow-lg transition" data-aos="flip-left" data-aos-delay="300">
        ...
        <p class="text-sm text-gray-200">Learn at your pace.</p>
      </div>
    </div>
  </div>
</section>
